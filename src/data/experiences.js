const experiences = [{
	...
	text: (
		<div>
			...
			<p className="margin-top-l">La startup venant de se créer, les aspects <strong>chefferie de projet</strong>, <strong>workflow technique</strong> et <strong>communication</strong> entre les équipes n'étaient pas encore mis en place. Cela m’a permis, avec l’aide de mon tuteur, de travailler sur ces points qui peuvent échapper aux personnes intégrant un établissement déjà structuré.</p>
			...
			<ul className="margin-top-m">
				...
				<li>Création d’une <strong>stratégie Google Analytics</strong> permettant la catégorisation de différents sous domaine en fonction du type de client (Hotels, Office de tourisme, etc.). Cette fonctionnalité comprenait un interfaçage avec notre API pour permettre la mise à jour et la création automatique de nouveaux clients. [<strong>Express.js, Mongoose</strong>]</li>
				...
				<li>Mise en place d’un workflow git, en l'occurence <strong>gitflow</strong></li>
			</ul>
	...
	text: (
		<div>
			...
			<p className="margin-top-l">L’objectif de celui-ci était, en utilisant le système de l’entreprise, de pouvoir utiliser un <strong>casque VR</strong> et ses manettes pour contrôler à distance un robot humanoïde nommé ENKI.</p>
			<p className="margin-top-l">L'étude technique nous a poussé à utiliser <strong>Unreal Engine</strong>, un moteur de jeu qui utilise le C++.</p>
			...
			<p className="margin-top-l">Nous les avons ensuite envoyées au robot à l’aide du système développé par la start-up ce qui lui a permis de pouvoir se mouvoir et par la même occasion nous renvoyer l’image perçu par le robot et l’afficher sur le casque VR.</p>
