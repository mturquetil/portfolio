const projects = [{
	...
	text: (
		<div>
			<p className="margin-top-s">L'esprit de ce projet est née d'un besoin d’optimisation global de mon workflow, mes performances machines, ainsi que de mon implication dans les systèmes unix et l'open source.</p>
			<p className="margin-top-l">En effet, au fil du temps, je me suis rendu compte que mon environnement technique (système d’exploitation et outils utilisés) tant sur le point professionnel que personnel n'était pas en accord avec mes valeurs personnels.</p>
			<p className="margin-top-l">Celui-ci était constitué principalement de composantes propriétaires sur lesquelles je ne pouvais avoir aucune influence, qui m'imposait une couche d'abstraction supplémentaire et qui était moins performantes.</p>
			<p className="margin-top-l">De part ma nature curieuse liée à ce besoin de transparence et d'indépendance technique, j'ai créé mon environnement de travail uniquement composé d’outil open source. Cela m'a permis d'améliorer mes connaissances dans le fonctionnement des systèmes unix et donc d’avoir une maîtrise de l'essentiel de mes outils.</p>
			<p className="margin-top-l">Pour continuer dans cette demarche, je suis en cours de migration vers l'utilisation d'un maximum d'outil base sur la philosophie <a className="nostyle" target="_blank" href="https://suckless.org/">suckless</a>.</p>
		</div>
	)
}, {
	...
	text: (
		<div>
			...
			<p className="margin-top-l">Ce passage à un usage intensif du clavier a par conséquent eu des répercussions sur l’utilisation de celui-ci. C’est pour cela que j’ai favorisé l’utilisation de la disposition <strong>QWERTY</strong> qui est plus disposée pour le développement informatique.</p>
			...
			<p className="margin-top-l">Pour conclure, ces modifications ont impliqué une réelle optimisation de mon utilisation de l’outil informatique mais reste coûteuse en terme de mise en place. Bien qu’elle implique de nombreux changements dans mes habitudes, je ressens déjà un véritable gain de temps et d’efficacité grâce à ces modifications.</p>
		</div>
	)
}, {
	...
	text: (<div>
		...
		<ul className="margin-top-m">
			...
			<li>Scan de QRCode ou saisie d’un code à 4 chiffres sur les e-billets des touristes</li>
